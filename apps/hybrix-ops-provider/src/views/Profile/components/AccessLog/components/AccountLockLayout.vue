<template>
  <p class="account-lock-title">Account Lock</p>
  <div class="account-lock-container">
    <div class="account-lock-list">
      <p v-for="(option, idx) in optionList" class="account-lock-list__item" :key="idx">
        <h-input
